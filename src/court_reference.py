...
class CourtReference:
    ...
    def __init__(self):
        ...
        self.court = cv2.cvtColor(cv2.imread('src/court_configurations/court_reference.png'), cv2.COLOR_BGR2GRAY)
    ...
    def save_all_court_configurations(self):
        ...
        for i, conf in self.court_conf.items():
            ...
            cv2.imwrite(f'src/court_configurations/court_conf_{i}.png', c)
